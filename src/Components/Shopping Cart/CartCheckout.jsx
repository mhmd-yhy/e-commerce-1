      ...
      <div className="bg-white rounded-lg border border-neutral-400 p-4">
        ...
        <div className="my-3">
          <div className="text-base text-center text-neutral-600 bg-white py-2 px-3 border border-neutral-400 rounded-lg">
            <span className={`${totalAfterDiscount !== 0 && "line-through text-red-600 ml-2"}`}> {totalCartPrice} جنيه </span>
            {
              totalAfterDiscount !== 0 && <span className={`${totalAfterDiscount !== 0 && "text-blue-700"}`}>{totalAfterDiscount} جنيه</span>
            }
