...
export default function SubTitle({ title, button, link }) {
  return (
    <div className="flex justify-between items-center font-bold my-6">
      ...
      {button ? (
        <NavLink to={link} className="px-5 py-px rounded-lg border border-neutral-600 text-neutral-600 text-xl duration-500 hover:bg-neutral-600 hover:text-stone-50" >
